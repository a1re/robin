...
Пас,<?=mb_substr($passing_leader["home_team"]["first_name"],0,1) . ". " . $passing_leader["home_team"]["last_name"]?> – <?=str_replace(",", "\,", $passing_leader["home_team"]["stats"])?>,<?=mb_substr($passing_leader["away_team"]["first_name"],0,1) . ". " . $passing_leader["away_team"]["last_name"]?> – <?=str_replace(",", "\,", $passing_leader["away_team"]["stats"])?><?=PHP_EOL?>
Вынос,<?=mb_substr($rushing_leader["home_team"]["first_name"],0,1) . ". " . $rushing_leader["home_team"]["last_name"]?> – <?=str_replace(",", "\,", $rushing_leader["home_team"]["stats"])?>,<?=mb_substr($rushing_leader["away_team"]["first_name"],0,1) . ". " . $rushing_leader["away_team"]["last_name"]?> – <?=str_replace(",", "\,", $rushing_leader["away_team"]["stats"])?><?=PHP_EOL?>
Прием,<?=mb_substr($receiving_leader["home_team"]["first_name"],0,1) . ". " . $receiving_leader["home_team"]["last_name"]?> – <?=str_replace(",", "\,", $receiving_leader["home_team"]["stats"])?>,<?=mb_substr($receiving_leader["away_team"]["first_name"],0,1) . ". " . $receiving_leader["away_team"]["last_name"]?> – <?=str_replace(",", "\,", $receiving_leader["away_team"]["stats"])?><?=PHP_EOL?>
[/table]
</textarea>
